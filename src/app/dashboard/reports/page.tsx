...
export default function ReportsPage() {
  ...
  // Module selection untuk superadmin atau admin dengan multiple access
  if (
    showModuleSelection &&
    (userData.role === 'superadmin' || userData.hasMultipleAccess)
  ) {
    return (
      <ModuleSelection
        ...
        <div className="relative mx-auto max-w-7xl">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              {/* Change module button - untuk superadmin atau admin dengan multiple access */}
